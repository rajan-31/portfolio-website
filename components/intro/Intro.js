		...
		<div className='flex md:flex-row flex-col-reverse md:justify-between'>
			<div className=''>
				...
				<div className='text-xl text-justify md:pr-10'>
					I&apos;m an undergraduate Information Technology Engineer. I love to explore new technologies and contribute to open-source projects. I write articles to teach new and emerging technologies. This website is (will be) my portfolio of learnings and projects.
				</div>
			</div>
